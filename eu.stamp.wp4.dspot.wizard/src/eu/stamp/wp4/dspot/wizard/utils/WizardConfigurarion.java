...
public class WizardConfigurarion {
	...
	/**
	 * @return a String array containing the names of the source files in the project
	 */
	...
	/**
	 * @return 
	 * a boolean array containing true in the positions of the test classes 
	...
	/**
	 * @return 
	 * a string array containing string of the form :
	 * <name of the test class>/<name of the annotated test method>
	 */
	...
	public static String getSeparator() {
		...
		if(os.contains("win")||os.contains("Win")) { return ";"; }
		return ":";
	}
	/**
	 * @param qname : complete qualified name of a class
	...
	/**
	 * @param partOfTheName : a fragment of the qualified name of a class in the selected project
	 * @return 
	 * the complete qualified name of the class in the selected project 
