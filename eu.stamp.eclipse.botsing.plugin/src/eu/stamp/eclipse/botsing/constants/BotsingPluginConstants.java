...
public abstract class BotsingPluginConstants {
    ...
    public static final String BOTSING_MAIN = "eu.stamp.eclipse.botsing.call.BotsingInvocation";
	public static final String BOTSING_JAR_URL = "platform:/plugin/eu.stamp.eclipse.botsing.plugin/lib/botsing-reproduction-1.0.4.jar";
