...
public abstract class BotsingPluginConstants {
    ...
    public static final String BOTSING_MAIN = "eu.stamp.eclipse.botsing.invocation.Invocation";
	public static final String BOTSING_JAR_URL = "platform:/plugin/eu.stamp.eclipse.botsing.plugin/lib/botsing-reproduction-0.0.1-SNAPSHOT-jar-with-dependencies.jar";
    public static final String BOTSING_INVOCATION_JAR_URL = "platform:/plugin/eu.stamp.eclipse.botsing.plugin/lib/Botsing-Invocation.jar";
