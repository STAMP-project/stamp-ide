...
import eu.stamp.eclipse.plugin.dspot.json.DSpotTestClassJSON.TestCase;
import eu.stamp.eclipse.plugin.dspot.json.DSpotTestClassJSON.TestCase.MutantKilled;
